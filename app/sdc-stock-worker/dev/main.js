...
const lib_nest_sqs_1 = __webpack_require__(8);
const mongoose_1 = __webpack_require__(9);
const sqs_consumer_module_1 = __webpack_require__(10);
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forRoot("mongodb+srv://OutsiderDetector:JEDHzMUEzM2m5G5G@serverlessinstance0.yzkltus.mongodb.net/", {
                ignoreUndefined: true,
                maxIdleTimeMS: 60000,
            }),
            lib_nest_sqs_1.SqsModule.forRoot({
                isGlobal: true,
                options: {
                    queueUrl: "https://sqs.ap-northeast-2.amazonaws.com/058264267608/sdc-stock-user-register",
...
"use strict";
module.exports = require("lib-nest-sqs");
...
const common_1 = __webpack_require__(6);
const feature_nest_stock_1 = __webpack_require__(11);
const sqs_consumer_service_1 = __webpack_require__(12);
...
exports.SqsConsumerModule = SqsConsumerModule = __decorate([
    (0, common_1.Module)({
        imports: [feature_nest_stock_1.UserModule],
...
"use strict";
module.exports = require("feature-nest-stock");
...
let SqsConsumerService = SqsConsumerService_1 = class SqsConsumerService {
    constructor(sqsService, userService) {
...
exports.SqsConsumerService = SqsConsumerService = SqsConsumerService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof lib_nest_sqs_1.SqsService !== "undefined" && lib_nest_sqs_1.SqsService) === "function" ? _a : Object, typeof (_b = typeof feature_nest_stock_1.UserService !== "undefined" && feature_nest_stock_1.UserService) === "function" ? _b : Object])
], SqsConsumerService);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("557aacad96e0f2d0c87d")
/******/ 	})();
/******/ 	
...
/******/ 			var update = require("../dist/" + __webpack_require__.hu(chunkId));
...
/******/ 			return Promise.resolve().then(function() {
/******/ 				return require("../dist/" + __webpack_require__.hmrF());
